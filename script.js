document.addEventListener('DOMContentLoaded', function () {
    ...
    function startTypewriterLabel() {
        ...
        typewriter.typeString('Ketik Nama Ibu/Bapak Guru').start();
    }
    ...
    function startTypewriterUcapan(nama) {
        ...
        typewriter
            .pauseFor(1000)
            .typeString(`<span>Halo, bapak/ibu ${nama}!</span>`)
            .pauseFor(1000)
            ...
            .callFunction(() => {
                ...
                tau.addEventListener('click', function() {
                    ...
                    .pauseFor(500)
                    .typeString('<br>disini saya cuman mau ngucapin sesuatu aja kok 🙂')
                    .callFunction(() => {
                        ...
                        lihat.addEventListener('click', function() {
                            ...
                            typewriter
                            .deleteAll(10)
                            .typeString('Surat cinta')
                            .pauseFor(500)
                            .typeString('<br>teruntuk guruku...')
                            .callFunction(() => {
                ...
                enggak.addEventListener('click', function() {
                    ...
                    typewriter
                    .deleteAll(10)
                    .typeString('Masa sih lupa😅')
                    .pauseFor(1000)
                    .typeString('<br>Yaudah gapapa,')
                    .pauseFor(500)
                    .typeString('sini biar saya jelasin ya😄')
                    .callFunction(() => {
                        ...
                        boleh.addEventListener('click', function() {
                            ...
                            .pauseFor(500)
                            .typeString('<br>Nah saya mau ngomong sesuatu aja sih sama ibu/bapak guru')
                            .pauseFor(500)
                ...
                lanjut.addEventListener('click', function() {
                    ...
                    .typeString('')
                    .pauseFor(500)
                    .typeString('<br>perpisahan aku dan engkau,')
                    .pauseFor(500)
                    .typeString('Wahai guruku..')
                    .callFunction(() => {
                        ...
                        lanjut1.addEventListener('click', function() {
                            ...
                            typewriter
                            .deleteAll(10)
                            .typeString('3 tahun telah berlalu')
                            .pauseFor(500)
                            .typeString('<br>kita bersama dalam kegiatan pembelajaran')
                            .callFunction(() => {
                                ...
                                lanjut2.addEventListener('click', function() {
                                    ...
                                    typewriter
                                    .deleteAll(10)
                                    .typeString('dengan penuh sabar dan semangat')
                                    .pauseFor(500)
                                    .typeString('<br>Engkau membimbing kami')
                                    .callFunction(() => {
                                        ...
                                        lanjut3.addEventListener('click', function() {
                                            ...
                                            typewriter
                                            .deleteAll(10)
                                            .typeString('Susah,senang,letih dan emosi')
                                            .pauseFor(500)
                                            .typeString('<br>mungkin itu pernah terbesit di benakmu')
                                            .callFunction(() => {
                                                ...
                                                lanjut4.addEventListener('click', function() {
                                                    ...
                                                    typewriter
                                                    .deleteAll(10)
                                                    .typeString('Namun engkau tetap mengajarkan kami kebaikan')
                                                    .pauseFor(500)
                                                    .callFunction(() => {
                                                                ...
                                                                lanjut6.addEventListener('click', function() {
                                                                    ...
                                                                    .callFunction(() => {
                                                                        ...
                                                                        lanjut7.addEventListener('click', function() {
                                                                            ...
                                                                            typewriter
                                                                            .deleteAll(10)
                                                                            .typeString('Semangat dan inspirasi anda akan selalu ada di hati kami.')
                                                                            .pauseFor(1000)
                                                                            .typeString('<br>Semoga anda sehat selalu dan diberikan keberkahan')
                                                                            .pauseFor(1000)
                                                                            .typeString('<br><br>--Dari muridmu--')
                                                                            .callFunction(() => {
        ...
        kisahRight.addEventListener('animationend', function() {
            ...
            kisahLeft.addEventListener('animationend', function() {
                ...
                kisahRightEnd.addEventListener('animationend', function() {
                    ...
                    typewriter
                    .typeString('<span>Kenangan<span>')
                    .pauseFor(500)
                    .typeString('<br><p>Saat Sekolah')
                    .pauseFor(1000)
                    .typeString('<br><div>Terimakasih guru,semoga engkau diberi kesehatan dan diberi umur yang panjang')
                    .callFunction(() => {
